CREATE DATABASE  IF NOT EXISTS `his` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `his`;
...
CREATE TABLE `drug` (
  ...
  `dosageForm` varchar(45) DEFAULT NULL COMMENT '剂型',
  `specification` varchar(45) DEFAULT NULL COMMENT '规格',
  `productionDate` varchar(45) DEFAULT NULL COMMENT '生产日期',
  `shelfLife` varchar(45) DEFAULT NULL COMMENT '保质期',
  `manufacturer` varchar(45) DEFAULT NULL COMMENT '厂家',
  `type` varchar(45) DEFAULT NULL COMMENT '类型',
  `OTC` varchar(45) DEFAULT NULL COMMENT '药品分类',
  `certificate` varchar(45) DEFAULT NULL COMMENT '批准文号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='药品';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `drug` VALUES (1,'五味子',50,29.90,'固体剂型','120g/瓶','2018-08-01','12个月','xx加工厂','中药','非处方药','国药准字Z11020338');
...
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8 COMMENT='收费单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pay` VALUES (1,'挂号收费',NULL,NULL,NULL,8,NULL),(2,'挂号收费',NULL,NULL,NULL,9,NULL),(3,'挂号收费',NULL,NULL,NULL,9,NULL),(4,'挂号收费',NULL,NULL,NULL,9,NULL),(5,'挂号收费',NULL,NULL,NULL,9,NULL),(6,'挂号收费',NULL,NULL,NULL,9,NULL),(7,'挂号收费',NULL,NULL,NULL,9,NULL),(8,'挂号收费',NULL,NULL,NULL,9,NULL),(9,'挂号收费',NULL,NULL,NULL,9,NULL),(10,'挂号收费',NULL,10.00,NULL,9,NULL),(11,'挂号收费',NULL,10.00,NULL,10,NULL);
...
CREATE TABLE `prescription` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '处方号',
  `patientId` varchar(18) DEFAULT NULL,
  `patientName` varchar(10) DEFAULT NULL,
  `doctor` varchar(45) DEFAULT NULL,
  `department` varchar(45) DEFAULT NULL,
  `text` varchar(45) DEFAULT NULL COMMENT '备注',
  `auditor` varchar(45) DEFAULT NULL COMMENT '审核人员',
  `date` date DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `处方病人_idx` (`patientId`),
  CONSTRAINT `处方病人` FOREIGN KEY (`patientId`) REFERENCES `patient` (`id`)
...
INSERT INTO `prescription` VALUES (0,'440882199508132345','张大田',NULL,NULL,NULL,NULL,NULL),(1,NULL,'张小田',NULL,NULL,NULL,NULL,NULL),(2,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
DROP TABLE IF EXISTS `pretext`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `pretext` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `preId` int(11) DEFAULT NULL,
  `sort` varchar(45) DEFAULT NULL COMMENT '分类',
  `drugName` varchar(45) DEFAULT NULL,
  `quantity` decimal(10,2) DEFAULT NULL,
  `usage` varchar(45) DEFAULT NULL COMMENT '使用方法',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='药方内容';
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `pretext` WRITE;
/*!40000 ALTER TABLE `pretext` DISABLE KEYS */;
INSERT INTO `pretext` VALUES (1,0,'剂药','山药',20.00,'煎煮'),(2,0,'剂药','山药2',10.00,'煎煮'),(3,0,'剂药','山药3',1.00,'煎煮'),(4,1,'剂药','山药',20.00,'煎煮'),(5,1,'剂药','山药2',10.00,'煎煮'),(6,1,'剂药','山药3',1.00,'煎煮');
/*!40000 ALTER TABLE `pretext` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `shift` (
  ...
  `date` date DEFAULT NULL COMMENT '轮班日期',
  `time` varchar(45) DEFAULT NULL COMMENT '轮班时段',
  `name` varchar(45) DEFAULT NULL,
  `sex` varchar(45) DEFAULT NULL,
  `phone` varchar(45) DEFAULT NULL COMMENT '科室',
  `department` varchar(45) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='轮班信息';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `shift` VALUES (1,12,'2019-06-22','大夜：00：00~8：00','黄中','男','13437884546','外科','迟到','黄上'),(2,6,'2019-06-20','早班：6:00~17:00','王二博','男','13437884564','骨科','工作时间','黄下'),(3,10,'2019-03-11','日班：10：00~21：00','肖沾','男','13437884566','精神科','早退','黄敏'),(4,2,'2018-04-02','小夜：16：00~00：00','孙苗苗','女','13437884524','急诊','病假','杨图'),(5,7,'2019-08-01','小夜：16：00~00：00','王大雅','女','13412384561','妇科','工作时间','黄敏'),(6,8,'2019-01-01','日班：10：00~21：00','王天霸','男','13432284566','口腔科','加班','杨图'),(7,3,'2019-02-03','日班：10：00~21：00','张大大','女','13431335241','护士室','工作时间','黄敏'),(8,4,'2019-03-02','日班：10：00~21：00','杨米','女','13437843643','胸心外科','工作时间','黄敏'),(9,5,'2018-11-09','早班：6:00~17:00','杨阳','男','13432143256','急诊','工作时间','黄敏'),(11,11,'2018-04-06','早班：6:00~17:00','陈肖','男','13442354536','精神科','工作时间','黄敏'),(12,9,'2018-06-30','早班：6:00~17:00','王岩','男','13467884566','外科','工作时间','黄敏'),(13,13,'2019-07-07','早班：6:00~17:00','黄豆','女','13778332566','妇科','工作时间','杨图'),(14,13,'2019-07-06','早班：6:00~17:00','黄豆','女','13778332566','妇科','工作时间','杨图'),(15,20,NULL,NULL,'王大傻','男',NULL,'口腔科',NULL,NULL);
...
-- Dump completed on 2019-08-12  1:44:00
